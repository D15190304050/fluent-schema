...
{
    @Test
    public void testGenerateSchemaMigration1() throws MojoExecutionException
    {
    ...
    @Test
    public void testGenerateSchemaMigration2() throws MojoExecutionException
    {
        EntityParser parser1 = new EntityParser();
        TableSchemaInfo tableSchemaInfoOfP1 = parser1.parse(P1.class);
        ...
        List<TableSchemaInfo> oldTableSchemaInfos = List.of(tableSchemaInfoOfP1, tableSchemaInfoOfP3);
        List<TableSchemaInfo> newTableSchemaInfos = List.of(tableSchemaInfoOfP2, tableSchemaInfoOfP4);
    ...
    @Test
    public void testGenerateSchemaMigration3() throws MojoExecutionException
    {
        EntityParser parser1 = new EntityParser();
        TableSchemaInfo tableSchemaInfoOfP1 = parser1.parse(P1.class);
        ...
        List<TableSchemaInfo> oldTableSchemaInfos = List.of(tableSchemaInfoOfP1, tableSchemaInfoOfP3, tableSchemaInfoOfP5);
        List<TableSchemaInfo> newTableSchemaInfos = List.of(tableSchemaInfoOfP2, tableSchemaInfoOfP4, tableSchemaInfoOfP6);
    ...
    @Test
    public void testGenerateSchemaMigration4() throws MojoExecutionException
    {
        EntityParser parser1 = new EntityParser();
        TableSchemaInfo tableSchemaInfoOfP1 = parser1.parse(P1.class);
        ...
        List<TableSchemaInfo> oldTableSchemaInfos = List.of(tableSchemaInfoOfP1, tableSchemaInfoOfP3, tableSchemaInfoOfP5, tableSchemaInfoOfP7);
        List<TableSchemaInfo> newTableSchemaInfos = List.of(tableSchemaInfoOfP2, tableSchemaInfoOfP4, tableSchemaInfoOfP6, tableSchemaInfoOfP8);
    ...
    @Test
    public void testGenerateSchemaMigration5() throws MojoExecutionException
    {
        EntityParser parser1 = new EntityParser();
        TableSchemaInfo tableSchemaInfoOfP1 = parser1.parse(P1.class);
    ...
    @Test
    public void testGenerateSchemaMigration6() throws MojoExecutionException
    {
        EntityParser parser1 = new EntityParser();
        TableSchemaInfo tableSchemaInfoOfP1 = parser1.parse(P1.class);
